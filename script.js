...
let weatherAPIKey = 'a5e8771ab05230e5675be17a1294020a';
...
let weatherImages = [{
    ...
    {
        url: 'images/mist.png',
        ids: [701, 711, 721, 731, 741, 751, 761, 771, 791]
    },
    {
        url: 'images/rain.png',
...
let updateForecast = (forecast) => {
    ...
    forecast.forEach(day => {
        ...
        let forecastItem = `<article class="weather_forecast_item">
